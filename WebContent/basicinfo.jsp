		...
		<div class="info">
			...
			<div class="basicinfo">
				...
				<form action="servlet/BasicinfoServlet" method="post">
					<dl>
						<dt>姓名</dt>
						<dd><input type="text" name="name" style="width:120px;height:30px"></dd>
					</dl>
					<dl>
						<dt>性别</dt>
						<dd>男<input type="radio" name="sex" value="男">&nbsp;</dd>
						<dd>女<input type="radio" name="sex" value="女"></dd>
					</dl>
					<dl>
						<dt>民族</dt>
						<dd><input type="text" name="nation" style="width:120px;height:30px"></dd>
					</dl>
					<dl>
						<dt>出生日期</dt>
						<dd>
						...
						<input type="date"style="width:180px;height:30px" placeholder="请输入出生年月"id="birthday" name="birthday" >
						</dd>
					...
					<dl>
						<dt>手机号码</dt>
						<dd><input type="text" name="tel" style="width:180px;height:30px"></dd>
					</dl>
					<dl>
						<dt>Email</dt>
						<dd><input type="text" name="email" style="width:180px;height:30px"></dd>
					</dl>
					<dl>
						<dt>居住地</dt>
						<dd><input id="liveaddr" type="text" name="liveaddr" style="width:120px;height:30px"><a class="acity"></a></dd>
					</dl>
					<dl>
						<dt>户口</dt>
						<dd><input id="residence" type="text" name="residence" style="width:120px;height:30px"><a class="acity1"></a></dd>
					</dl>
					<div class="button">
						<input type="submit" value="下一步"onclick="return myfunction()">
					</div>
				</form>
			</div>
		</div>
