		...
		<div class="info">
			...
			<div class="education">
				...
				<form action="servlet/EducationServlet" method="post">
					...
					<dl>
						<dt>学校</dt>
						<dd><input type="text" name="eduschool" style="width:240px;height:30px"></dd>
					</dl>
					<dl>
						<dt>专业</dt>
						<dd><input type="text" name="edumajor" style="width:240px;height:30px"></dd>
					</dl>
					<dl>
						<dt>学历</dt>
						<dd>
					...
					<dl>
						<dt>校内职务</dt>
						<dd><textarea name="eduduty" style="width:300px;height:100px" placeholder="格式如:2012年9月-2013年6月 班长"></textarea></dd>
					</dl>
					<dl>
						<dt>在校奖励</dt>
						<dd><textarea name="eduaward" style="width:300px;height:100px" placeholder="格式如:2012年9月-2013年6月 一等奖学金"></textarea></dd>
					</dl>
					<dl>
						<dt>社会实践</dt>
						<dd><textarea name="eduprictise" style="width:300px;height:100px" placeholder="格式如:2012年9月-2013年6月 xx实习"></textarea></dd>
					</dl>
					<dl>
						<dt>海外学习经历</dt>
						<dd><input type="radio" name="abroad" value="是">是&nbsp;</dd>
						<dd><input type="radio" name="abroad" value="否">否</dd>
					</dl>
					<div class="button">
