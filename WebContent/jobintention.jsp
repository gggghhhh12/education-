		...
		<div class="info">
			...
			<div class="jobintention">
				...
				<form action="servlet/JobIntentionServlet" method="post">
					<dl>
						<dt>关键词</dt>
						<dd><input type="text" name="keyword" style="width:420px;height:30px" placeholder="如：行业、特长，不超过10个字，用空格分开"></dd>
					</dl>
					<dl>
						<dt>个人评价</dt>
						<dd><textarea name="evaluation" style="width:420px;height:100px" placeholder="输入自己的个人评价，120字以内"></textarea></dd>
					</dl>
					<dl>
						<dt>求职地点</dt>
						<dd><input id="place" type="text" name="place" style="width:120px;height:30px"><a class="acity"></a></dd>
					</dl>	
					<dl>
						<dt>行业</dt>
						<dd><input id="trade" type="text" name="trade" style="width:120px;height:30px"><a class="atrade"></a></dd>
					</dl>
					<dl>
						<dt>期望月薪</dt>
						<dd>
					...
					<div class="button">
						<input type="submit" value="保 存" onclick="myfunction()">
					</div>
				</form>
			</div>
		</div>
