		...
		<div class="info">
			...
			<div class="basicinfo">
				...
				<form action="servlet/EPPostJobServlet" method="post">
					<dl>
						<dt>职位名称</dt>
						<dd><input id="jobname" type="text" name="jobname" style="width:200px;height:30px"></dd>
					</dl>
					<dl>
						<dt>职位薪资</dt>
						<dd>
					...
					<dl>
						<dt>招聘人数</dt>
						<dd><input type="text" name="reqnum" value="1" style="width:50px;height:30px">&nbsp;人</dd>
					</dl>
					<dl>
						<dt>公司福利</dt>
						<dd><input type="text" name="benefits" style="width:300px;height:30px" placeholder="不超过20个字，每个词之间用空格隔开"></dd>
					</dl>
					<dl>
						<dt>职位描述</dt>
						<dd><textarea name="jobdescribe" style="width:300px;height:100px" placeholder="不超过200字"></textarea></dd>
					</dl>
					<dl>
						<dt>岗位职责</dt>
						<dd><textarea name="jobduty" style="width:300px;height:100px" placeholder="不超过200字，按点换行"></textarea></dd>
					</dl>
					<dl>
						<dt>技术要求</dt>
						<dd><textarea name="techrequest" style="width:300px;height:100px" placeholder="不超过200字，按点换行"></textarea></dd>
					</dl>
					<dl>
						<dt>职能类别</dt>
						<dd><input id="jobkind" type="text" name="jobkind" style="width:200px;height:30px"><a class="ajobkind"></a></dd>
					</dl>
					<dl>
						<dt>上班地址</dt>
						<dd><input type="text" name="jobaddr" style="width:300px;height:30px"></dd>
					</dl>
					<div class="button1">
