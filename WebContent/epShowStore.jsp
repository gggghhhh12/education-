...
<html>
  <head>
	...
	<style type="text/css">
		...
		<%@ include file="./css/epShowStore.css"%>
	</style>
    ...
    <div id="mainbody">
    	<div class="store">
			...
			<div class="storeContent">
				<c:forEach var="stuUser" items="${stuUsers }">
					<div class="single">
						<span class="t1"><a href="servlet/StuResumeDetailServlet?stuUsername=${stuUser.stuUsername }" target="_blank">${stuUser.stuName }</a></span>
						<span class="t2">${stuUser.sex }</span>
						<span class="t3">${stuUser.school }</span>
						<span class="t4">${stuUser.major }</span>
		...
		<div class="recommend">
			...
			<div class="recdContent">
				<span class="s1">
					<a href="servlet/StuResumeDetailServlet?stuUsername=${recommends1[0].stuUsername }" target="_blank">${recommends1[0].stuName }</a>
				</span>
				<span class="s2">${recommends1[0].sex }</span>
				<span class="s3">${recommends1[0].school }</span>
				<span class="s4">${recommends1[0].major }</span>
				<hr>
				<span class="s1">
					<a href="servlet/StuResumeDetailServlet?stuUsername=${recommends1[1].stuUsername }" target="_blank">${recommends1[1].stuName }</a>
				</span>
				<span class="s2">${recommends1[1].sex }</span>
				<span class="s3">${recommends1[1].school }</span>
				<span class="s4">${recommends1[1].major }</span>
				<hr>
				<span class="s1">
					<a href="servlet/StuResumeDetailServlet?stuUsername=${recommends1[2].stuUsername }" target="_blank">${recommends1[2].stuName }</a>
				</span>
				<span class="s2">${recommends1[2].sex }</span>
				<span class="s3">${recommends1[2].school }</span>
