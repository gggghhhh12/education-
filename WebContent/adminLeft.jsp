...
<html>
  ...
  <body>
    <div class="menu">
		<a href="adminIndex.jsp" target="rightFrame">
			<span class="span1">
				<img src="./images/lefticon01.png"/>
				<span class="title">首页</span>
			</span>
		</a>
		<div class="span"><img src="./images/lefticon01.png"/><div class="title">管理信息</div></div>
		<ul>
		...
		<div class="span"><img src="./images/lefticon01.png"/><div class="title">审核管理</div></div>
		<ul>
		...
		<div class="span"><img src="./images/lefticon01.png"/><div class="title">毕业生管理</div></div>
		<ul>
			<li><a href="servlet/AdminShowStuUserServlet" target="rightFrame">毕业生账号管理</a></li>
			<li><a href="servlet/AdminShowResumeServlet" target="rightFrame">毕业生简历管理</a></li>
		</ul>
		<div class="span"><img src="./images/lefticon01.png"/><div class="title">企业管理</div></div>
		<ul>
			<li><a href="servlet/AdminLatestEPDataServlet" target="rightFrame">最近更新的企业信息</a></li>
			...
			<li><a href="servlet/AdminShowPostJobServlet" target="rightFrame">企业职位管理</a></li>
			<li><a href="servlet/AdminShowCommentServlet" target="rightFrame">企业评论管理</a></li>
		</ul>
		<div class="span"><img src="./images/lefticon01.png"/><div class="title">图表管理</div></div>
		<ul>
