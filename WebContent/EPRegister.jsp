    ...
    <div class="login">
		...
		<div class="login-top">
			...
			<form action="servlet/EPRegisterServlet" method="post">
				...
				<input type="password" name="EPpassword" placeholder="pasword">
				<input type="password" name="EPconfirmPassword" placeholder="Confirm Password">
	    		<div class="forgot">
		...
		<div class="login-bottom">
			<h3>老用户 &nbsp;<a href="EPLogin.jsp">登录</a>&nbsp;</h3>
		</div>
	</div>
  </body>
</html>
