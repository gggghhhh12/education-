...
<div id="header">
	<nav id="wrap">
		...
		<ul>
			...
			<li>
				<a href="servlet/StuShowStuWantedServlet" class="flag">我的邀约</a>
		...
		<div class="keyword">
			...
			<form action = "servlet/StuSearchJobByKeyWordServlet" method="post">
				<input type="text" name="keyword" class="texttype" placeholder="输入你要搜索的公司或职位">
				<input type="submit" value="搜索" class="subtype">
			</form>
		</div>
	</nav>
</div>
