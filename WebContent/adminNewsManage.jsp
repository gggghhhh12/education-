...
<html>
  ...
  <body>
    ...
    <div class="tool">
		<ul>
			<li class="add"><input type="button" value="添加"></input></li>
			<li class="modify"><input type="button" value="修改"></input></li>
		</ul>
	</div>
	<div class="tablelist">
		<table style="width:98%; border-collapse:collapse; border-spacing:0;"> 
			<tr>
				<th width="5%"></th><th width="5%">编号</th><th width="20%">新闻标题</th>
				<th width="40%">新闻内容</th><th width="20%">发布时间</th><th width="10%">操作</th>
			</tr>
			<c:forEach var="n" items="${news }">
				<tr>
					<td width="5%"><input type="checkbox" name="news" value="${n.news_id }"></input></td><td width="5%">${n.news_id }</td><td width="20%">${n.news_title }</td>
					<td width="40%">${n.news_content }</td><td width="20%">${n.news_time }</td><td width="10%"><a>删除</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
	...
	<div class="mask">
		<dl>
			<dt>新闻编号</dt>
			<dd><input type="text" id="newsId" style="height: 30px;width: 300px"></input></dd>
		</dl>
		<dl>
			<dt>新闻标题</dt>
			<dd><input type="text" id="newsTitle" style="height: 30px;width: 300px"></input></dd>
		</dl>
		<dl>
			<dt>新闻内容</dt>
			<dd><textarea id="newsContent" style="height: 100px;width: 300px"></textarea></dd>
		</dl>
		<div>
			<input class="yes" type="button" value="添加"></input>
			<input class="no" type="button" value="取消"></input>
		</div>
	</div>
	...
	<div class="mask1">
		<dl>
			<dt>新闻编号</dt>
			<dd><input type="text" id="newsId1" style="height: 30px;width: 300px" readonly="readonly"></input></dd>
		</dl>
		<dl>
			<dt>新闻标题</dt>
			<dd><input type="text" id="newsTitle1" style="height: 30px;width: 300px"></input></dd>
		</dl>
		<dl>
			<dt>新闻内容</dt>
			<dd><textarea id="newsContent1" style="height: 100px;width: 300px"></textarea></dd>
		</dl>
		<div>
			<input class="yes" type="button" value="修改"></input>
			<input class="no" type="button" value="取消"></input>
		</div>
	</div>
  </body>
