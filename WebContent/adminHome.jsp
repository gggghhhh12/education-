...
<html>
  <head>
	...
	<frameset rows="88,*,33" cols="*" frameborder="no" border="0" framespacing="0">
		...
		<frameset cols="189,*" frameborder="no" border="0" framespacing="0">
			...
			<frame src="adminIndex.jsp" name="rightFrame" id="rightFrame" title="rightFrame" />
		</frameset>
		<frame src="adminFooter.jsp" name="bottomFrame" scrolling="No" noresize="noresize" id="bottomFrame" title="bottomFrame" />
	</frameset>
  </head>
