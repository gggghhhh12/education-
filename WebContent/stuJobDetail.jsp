...
<html>
  <head>
	...
	<style type="text/css">
		...
		<%@ include file="./css/stuJobDetail.css"%>
	</style>
	...
	<div id="mainbody">
		<div class="leftInfo">
			<div class="epInfo">
				...
				<div class="operation">
					<span><input type="button" value="申请职位"></input></span>
					<span class="store"><a>收藏</a></span>
				</div>
			...
			<div class="recommend">
				...
				<c:if test="${!empty recommends }">
					<div class="recdContent">
						...
						<span class="s1">
							<a href="servlet/StuJobDetail?EPusername=${recommends[0].EPusername }&jobname=${recommends[0].jobname }" target="_blank">${recommends[0].jobname }</a>
						</span>

						<span class="s2">${recommends[0].salary }</span>
				    <% 
					if(userlevel.equals("0"))
					{
					%>
					...
					<%} %>	
						...
						<hr>
						<span class="s1">
							<a href="servlet/StuJobDetail?EPusername=${recommends[1].EPusername }&jobname=${recommends[1].jobname }" target="_blank">${recommends[1].jobname }</a>
						</span>
						


					<span class="s2">${recommends[1].salary }</span>
				    <% 
					if(userlevel.equals("0"))
					{
					%>
					...
					<%} %>	
						...
						<hr>
						<span class="s1">
							<a href="servlet/StuJobDetail?EPusername=${recommends[2].EPusername }&jobname=${recommends[2].jobname }" target="_blank">${recommends[2].jobname }</a>
						</span>
						
						
					<span class="s2">${recommends[2].salary }</span>
				    <% 
					if(userlevel.equals("0"))
					{
					%>
		...
		<div class="rightInfo">
			<div class="title">
				<div class="jobname"><h1>${epPostJob.jobname }</h1></div>
				<div class="report">举报</div>
				<div class="msg"></div>
				<div class="salary"><h1>${epPostJob.jobsalary }/月</h1></div>
			</div>
			<div class="detail">
			...
			<div class="diploma">
				<span class="t1">学历要求</span>
				<span class="t2">${epPostJob.jobdiploma }</span>
			</div>
			<div class="engreq">
				<span class="t1">英语能力要求</span>
				<span class="t2">${epPostJob.engrequest }</span>
			</div>
			<div class="reqnum">
				<span class="t1">招聘人数</span>
				<span class="t2">${epPostJob.reqnum }人</span>
			</div>
			<h3>职位详情</h3>
			<hr align="center" size="4px" color="#DCE0E7" noshade>
			<dl>
			...
			<div class="comment">
				...
				<div class="content">
					...
					<input type="radio" name="relation" value="员工好友">员工好友
					<input type="radio" name="relation" value="合作伙伴">合作伙伴
					<input type="radio" name="relation" value="客户">客户
					<input type="radio" name="relation" value="关注者">关注者
					<textarea placeholder="请写下您的点评，50字以内"></textarea>
					<input id="btnConfirm" type="button" value="提交"></input>
					<input id="btnCancel" type="button" value="取消"></input>
