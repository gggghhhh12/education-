...
<div class="container">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#home">自动化</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu1">人工智能</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu2">大数据</a>
        </li>
    </ul>
    ...
    <div class="TabbedPanelsContent">
		...
		<div class="login-top">
			...
			<form action="servlet/EPLoginServlet" method="post">
	    		...
	    		<div class="forgot">
	    			<div class="error">${error }</div>
	    			<a href="modifyPassword.jsp?usertype=enterprise">修改密码</a>
	    			<input type="submit" value="登录" >
	    		</div>
	   		</form>
		</div>
		<div class="login-bottom">
			<h3>新用户 &nbsp;<a href="EPRegister.jsp">注册</a>&nbsp;</h3>
		</div>
	</div>	
    </div>
  </div>
