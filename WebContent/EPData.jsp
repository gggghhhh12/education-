		...
		<div class="info">
			...
			<div class="basicinfo">
				...
				<form action="servlet/EPDataServlet" method="post">
					<dl>
						<dt>公司名称</dt>
						<dd><input type="text" name="EPname" style="width:200px;height:30px"></dd>
					</dl>
					<dl>
						<dt>公司性质</dt>
						<dd>
							<select name="EPnature">
								...
								<option value="股份制合作制公司">股份制合作制公司</option>
					...
					<dl>
						<dt>公司机构代码</dt>
						<dd><input type="text" name="EPcode" style="width:180px;height:30px"></dd>
					</dl>
					<dl>
						<dt>所属行业</dt>
						<dd><input id="EPtrade" type="text" name="EPtrade" style="width:180px;height:30px"><a class="atrade"></a></dd>
					</dl>
					<dl>
						<dt>公司规模</dt>
						<dd>
					...
					<dl>
						<dt>公司所在地</dt>
						<dd><input id="EPaddr" type="text" name="EPaddr" style="width:180px;height:30px"><a class="acity"></a></dd>
					</dl>
					<dl>
						<dt>联系人</dt>
						<dd><input type="text" name="EPcontact" style="width:180px;height:30px"></dd>
					</dl>
					<dl>
						<dt>电子邮箱</dt>
						<dd><input type="text" name="EPemail" style="width:180px;height:30px"></dd>
					</dl>
					<dl>
						<dt>固定电话</dt>
						<dd><input type="text" name="EPtel" style="width:180px;height:30px"></dd>
					</dl>
					<dl>
						<dt>手机号码</dt>
						<dd><input type="text" name="EPmobile" style="width:180px;height:30px"></dd>
					</dl>
					<dl>
						<dt>邮政编码</dt>
						<dd><input type="text" name="EPpostalcode" style="width:180px;height:30px"></dd>
					</dl>
					<dl>
						<dt>公司简介</dt>
						<dd><textarea name="EPintroduction" style="width:300px;height:100px" placeholder="不超过500字"></textarea></dd>
					</dl>
					<div class="button">
